							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="删除" onclick="deleteOrder()">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="orders">
										...
										<tr>
											<td><input id="checkbox_all" value="${orders.id }" name="ids" type="checkbox"></td>
											<td>${orders.id }</td>
	...
	<script>
		...
		function deleteOrder() {
			...
			$.ajax({
				...
				async:true,
				traditional:true,
				data:{"orderIds":arrayObj},
				dataType:"json",
				success:function(data){
					alert(data);
					switch (data) {
						case 200:
							window.location.href = "${pageContext.request.contextPath}/orders/findAll.do";
					}
				}
			});
		}
