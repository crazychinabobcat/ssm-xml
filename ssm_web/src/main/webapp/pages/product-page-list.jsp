...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <script src="/ssm_web/js/jquery-1.3.2.js" type="text/javascript"></script>
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="删除" onclick="deleteProduct()">

											<i class="fa fa-trash-o"></i> 删除
										</button>
										<button type="button" class="btn btn-default" title="开启" onclick="updateProduct()">
											<i class="fa fa-check"></i> 开启
										</button>
										<button type="button" class="btn btn-default" title="屏蔽">
											<i class="fa fa-ban"></i> 屏蔽
										</button>
										<button type="button" class="btn btn-default" title="刷新" onclick="replaceProduct()">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="product">
										<tr>
											<td><input id="checkbox_all" name="ids" value="${product.id }" type="checkbox"></td>
											<td  name="productidlist" >${product.id }</td>
		...
		function updateProduct() {
			...
			for (var i=0;i<checkArry.length;i++){
				if (checkArry[i].checked){
					arrayObj.push(checkArry[i].value)
				}
			}
			$.ajax({
				type:"POST",
